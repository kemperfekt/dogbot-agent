...
from src.v2.core.exceptions import V2ValidationError
...
def mock_integrated_prompt_manager():
    ...
    prompt_responses = {
        ...
        PromptType.DOG_INSTINCT_PERSPECTIVE: "Als Hund mit {primary_instinct}-Instinkt fühle ich {primary_description}.",
