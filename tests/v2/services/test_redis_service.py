...
from src.v2.services.redis_service_original import (
    RedisService,
    RedisConfig,
    create_redis_service,
    get_redis_singleton
)
from src.v2.core.exceptions import RedisServiceError
...
async def redis_service(mock_config, mock_redis_client):
    ...
    with patch('src.v2.services.redis_service_original.redis.from_url', return_value=mock_redis_client):
...
class TestRedisService:
    ...
    async def test_connection_failure(self, mock_config):
        ...
        with patch('src.v2.services.redis_service_original.redis.from_url', return_value=failing_client):
