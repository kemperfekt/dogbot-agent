...
from src.v2.services.weaviate_service import (
    WeaviateService, 
    WeaviateConfig, 
...
async def weaviate_service(mock_config, mock_weaviate_client):
    ...
    with patch('src.v2.services.weaviate_service.weaviate.connect_to_weaviate_cloud', 
...
class TestWeaviateService:
    ...
    async def test_initialization(self, mock_config):
        ...
        with patch('src.v2.services.weaviate_service.weaviate.connect_to_weaviate_cloud') as mock_connect:
            mock_client = Mock()
